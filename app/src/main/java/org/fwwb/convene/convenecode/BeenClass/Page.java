...
public class Page {
    ...
    public String getQuestionUcode() {
        return questionUcode;
    }

    public void setQuestionUcode(String questionUcode) {
        this.questionUcode = questionUcode;
    }
}