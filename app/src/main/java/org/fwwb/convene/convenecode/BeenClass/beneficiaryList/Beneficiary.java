package org.fwwb.convene.convenecode.BeenClass.beneficiaryList;
...
public class Beneficiary {
    ...
    public int getLeastLocationId() {
        return leastLocationId;
    }

    public void setLeastLocationId(int leastLocationId) {
    ...
    public void setBeneficiaryTypeId(int beneficiaryTypeId) {
