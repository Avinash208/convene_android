...
import org.fwwb.convene.convenecode.BeenClass.ActivityRuleSet_;
import org.fwwb.convene.convenecode.beansClassSetQuestion.ParentLink;
...
public class SurveyDetail implements Parcelable{
    ...
    @SerializedName("activity_rule_set")
    @Expose
    private List<ActivityRuleSet_> activityRuleSets = new ArrayList<ActivityRuleSet_>();
    ...
    @SerializedName("display_in_training")
    @Expose
    private Integer displayInTraining;

    @SerializedName("is_training_survey")
    @Expose
    private Integer isTrainingSurvey;
    ...
    public List<ActivityRuleSet_> getActivityRuleSets() {
        return activityRuleSets;
    }

    public void setActivityRuleSets(List<ActivityRuleSet_> activityRuleSets) {
        this.activityRuleSets = activityRuleSets;
    }
    ...
    public Integer getDisplayInTraining() {
        return displayInTraining;
    }

    public void setDisplayInTraining(Integer displayInTraining) {
        this.displayInTraining = displayInTraining;
    }

    public Integer getIsTrainingSurvey() {
        return isTrainingSurvey;
    }

    public void setIsTrainingSurvey(Integer isTrainingSurvey) {
        this.isTrainingSurvey = isTrainingSurvey;
    }
}