...
import org.fwwb.convene.convenecode.Beneficiarylinkages;
    ...
    public void onBindViewHolder(ListingGridViewAdapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.editbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Utilities.setSurveyStatus(prefsMY, "edit");
    ...
    private void setImageDynamically(ImageView imageView, String headingLabel, String getGender) {
        switch (headingLabel) {
            case Constants.CLUSTER:
                imageView.setBackgroundResource(R.drawable.fwwb_batchicon);
                break;
            case Constants.FPO:
