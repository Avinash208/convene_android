...
import org.fwwb.convene.convenecode.api.BeneficiaryApis.ServiceTypeInterface;
import org.fwwb.convene.convenecode.api.FacilitiesListAsyncTask;
...
public class HomeActivity extends BaseActivity implements BeneficaryTypeInterface, View.OnClickListener, FacilityTypeInterface, ServiceTypeInterface, PopupMenu.OnMenuItemClickListener, ClusterToTypo {
    ...
    private CardView dataformsLinear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tvTraining).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initVariables() {
        ...
        dataformsLinear = findViewById(R.id.card_view);
