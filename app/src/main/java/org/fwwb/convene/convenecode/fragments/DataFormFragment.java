package org.fwwb.convene.convenecode.fragments;
...
import org.fwwb.convene.convenecode.backgroundtasks.CompletedSurveyAsyncTask;
import org.fwwb.convene.convenecode.backgroundtasks.PendingSurveyAsyncTask;
...
import org.fwwb.convene.convenecode.utils.multispinner.SingleSpinnerSearch;
...
public class DataFormFragment extends Fragment implements PeriodicTypeInterface, PendingCompletedSurveyAsyncResultListener {
    ...
    private void createPendingRecordView(SurveysBean surveysBean, String benAndFaci) {
        ...
        if (defaultPreferences.getBoolean(Constants.SHOWPERIODICITYFLAG,false)){
            periodicityName.setVisibility(View.VISIBLE);
        }else{
    ...
    private void showSummeryReport() {
        ...
        for (int i = 0; i < completedSurveyList.size(); i++) {
            ...
            if (defaultPreferences.getBoolean(Constants.SHOWPERIODICITYFLAG,false)){
                ...
                periodicityTextview.setVisibility(View.GONE);
            }
