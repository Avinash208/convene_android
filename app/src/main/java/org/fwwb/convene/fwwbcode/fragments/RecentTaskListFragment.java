...
/**
     ...
     */
    public  class RecentTaskListFragment extends Fragment implements TaskListListeners{

    public TextView emptyTextView;
    public RecyclerView listView;
    public List<TaskItemBean>  itemBeanList = new ArrayList<>();

    public RecentTaskListFragment() {
        }
         ...
         * number.
         */
        public static RecentTaskListFragment newInstance() {
            RecentTaskListFragment fragment = new RecentTaskListFragment();
