...
import org.mahiti.convenemis.SupportClass;
...
import org.mahiti.convenemis.adapter.spinnercustomadapter.CustomNewSpinnerAdapter;
...
public class AddBeneficiaryUtils {
    ...
    public static JSONArray getFacilityArray(List<org.mahiti.convenemis.BeenClass.facilities.Datum> beneficiaryList, int position){
    ...
    public static void beneficiaryLocationSetting(List<org.mahiti.convenemis.BeenClass.facilities.Datum> beneficiaryList, int position, TextView textView){
