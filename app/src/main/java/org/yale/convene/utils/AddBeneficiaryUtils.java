...
import org.yale.convene.SurveyListLevels;
...
import org.yale.convene.adapter.spinnercustomadapter.CustomNewSpinnerAdapter;
...
public class AddBeneficiaryUtils {
    ...
    public static JSONArray getFacilityArray(List<org.yale.convene.BeenClass.facilities.Datum> beneficiaryList, int position){
    ...
    public static void beneficiaryLocationSetting(List<org.yale.convene.BeenClass.facilities.Datum> beneficiaryList, int position, TextView textView){
