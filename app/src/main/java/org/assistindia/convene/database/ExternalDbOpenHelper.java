...
import org.assistindia.convene.BeenClass.Activitylist;
import org.assistindia.convene.BeenClass.Levelid;
import org.assistindia.convene.BeenClass.Project;
import org.assistindia.convene.BeenClass.ProjectList;
import org.assistindia.convene.BeenClass.QuestionAnswer;
import org.assistindia.convene.BeenClass.ResponsesData;
import org.assistindia.convene.BeenClass.StatusBean;
...
import org.assistindia.convene.BeenClass.beneficiary.GetBeneficiaryDetails;
import org.assistindia.convene.BeenClass.beneficiaryList.Beneficiary;
import org.assistindia.convene.BeenClass.facilities.FacilitiesList;
import org.assistindia.convene.BeenClass.facilities.Facility;
import org.assistindia.convene.BeenClass.facilitiesBeen.FacilitySubTypeBeen;
import org.assistindia.convene.BeenClass.parentChild.Level1;
import org.assistindia.convene.BeenClass.parentChild.LevelBeen;
import org.assistindia.convene.BeenClass.parentChild.LevelFive;
import org.assistindia.convene.BeenClass.parentChild.LevelFour;
import org.assistindia.convene.BeenClass.parentChild.LevelOne;
import org.assistindia.convene.BeenClass.parentChild.LevelSeven;
import org.assistindia.convene.BeenClass.parentChild.LevelSix;
import org.assistindia.convene.BeenClass.parentChild.LevelThree;
import org.assistindia.convene.BeenClass.parentChild.LevelTwo;
import org.assistindia.convene.BeenClass.parentChild.LinkagesList;
import org.assistindia.convene.BeenClass.parentChild.LocationSurveyBeen;
import org.assistindia.convene.BeenClass.parentChild.SurveyDetail;
import org.assistindia.convene.BeenClass.parentChild.SurveyListDetails;
import org.assistindia.convene.BeenClass.service.ServiceList;
import org.assistindia.convene.R;
import org.assistindia.convene.utils.CommonForAllClasses;
import org.assistindia.convene.utils.Constants;
import org.assistindia.convene.utils.Logger;
import org.assistindia.convene.utils.PeriodicityUtils;
...
public class ExternalDbOpenHelper extends SQLiteOpenHelper {
     ...
     * @return
     */
    public List<org.assistindia.convene.BeenClass.facilities.Datum> getFacilityDetailsFromDB(String btype, int filterOrder, String lastModifiedDate) {
        List<org.assistindia.convene.BeenClass.facilities.Datum> facilityList = new ArrayList<>();
        ...
        try {
            ...
            if (cursor.getCount() != 0 && cursor.moveToFirst()) {
                do {
                    org.assistindia.convene.BeenClass.facilities.Datum datum = new org.assistindia.convene.BeenClass.facilities.Datum();
    ...
    private void setServicesToBean(String service, org.assistindia.convene.BeenClass.facilities.Datum datum, List<Integer> servicesList) {
        String servicesSplitedString = service.replaceAll("\\[", "").replaceAll("\\]", "");
        if (!servicesSplitedString.isEmpty()) {
            String[] serviceList = servicesSplitedString.split(",");
            servicesList = new ArrayList<>();
     ...
     * @return
     */
    public List<org.assistindia.convene.BeenClass.service.Datum> getServiceName(String tableName) {
        List<org.assistindia.convene.BeenClass.service.Datum> serviceList = new ArrayList<>();
        SQLiteDatabase db = openDataBase();
        Logger.logV(TAG, tagStr + db.getPath());
        ...
        if (cursor.getCount() != 0 && cursor.moveToFirst()) {
            do {
                org.assistindia.convene.BeenClass.service.Datum datum = new org.assistindia.convene.BeenClass.service.Datum();
        ...
        try {
            ...
            if (cursor.getCount() != 0 && cursor.moveToFirst()) {
                do {
                    ...
                    JSONArray jsonArray = new JSONArray(addressString);
                    List<org.assistindia.convene.BeenClass.beneficiary.Address> addressList = new ArrayList<>();
                    for (int j = 0; j < jsonArray.length(); j++) {
                        Address address = new Address();
                        JSONObject jsonobject = jsonArray.getJSONObject(j);
                        address.setAddress1(jsonobject.getString(ADDRESS1_KEY));
     ...
     * @return
     */
    public List<org.assistindia.convene.BeenClass.facilities.Datum> getFacilityNameForFilter(String userEnterText, String btypeid, String modifiedDate) {
        List<org.assistindia.convene.BeenClass.facilities.Datum> facilityList = new ArrayList<>();
        List<Integer> servicesList = new ArrayList<>();
        SQLiteDatabase db = openDataBase();
        facilityList.clear();
     ...
     * @return
     */
    public List<org.assistindia.convene.BeenClass.facilities.Datum> getFilteredSurveyIdFacility(String query) {
        List<org.assistindia.convene.BeenClass.facilities.Datum> beneficiaryName = new ArrayList<>();
