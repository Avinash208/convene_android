...
import org.assistindia.convene.SupportClass;
import org.assistindia.convene.SurveyListLevels;
...
import org.assistindia.convene.adapter.spinnercustomadapter.CustomNewSpinnerAdapter;
...
public class AddBeneficiaryUtils {
    ...
    public static JSONArray getFacilityArray(List<org.assistindia.convene.BeenClass.facilities.Datum> beneficiaryList, int position){
    ...
    public static void beneficiaryLocationSetting(List<org.assistindia.convene.BeenClass.facilities.Datum> beneficiaryList, int position, TextView textView){
